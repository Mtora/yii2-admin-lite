        ...
        <div class="card">
            <div class="card-body">
                <div class="dt-buttons pull-right">
                    <a href="<?= Url::to(['role/add-role']) ?>" class="btn btn-primary">添加角色</a>
                </div>
                    ...
                    <table class="table table-bordered table-hover toggle-circle tablet breakpoint footable-loaded footable" style="width: 99%">
                        ...
                        <?php foreach ($roles as $role) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?=Url::to(['role/edit-role','rolename' => $role->name])?>" class="label label-primary"><i class="fa fa-edit"></i> 编辑</a>&nbsp;
                                    <a href="<?=Url::to(['role/del-role-submit','rolename' => $role->name])?>" class="label label-danger"><i class="fa fa-trash"></i> 删除</a>
                                </td>
                            </tr>
                        <?php endforeach;?>
                        </tbody>
